...
var id = <Language> {
    ...
    create_subtext: "Kami akan membuat wallet baru agar anda dapat mulai menggunakan Danecoin.",
    ...
    // Send
    send_to: 'Kirim hanya kepada address Danecoin (DANE)',
    bitcoin_address: 'Address Danecoin',
    address: 'Address',
    ...
    dust_error: "Jumlah yang anda kehendaki terlalu kecil untuk proses jaringan Danecoin.",
    bitcoin_network_fee: "Biaya Jaringan Danecoin",

    // Receive
    receive_only: 'Terima hanya Danecoin',
