...
var es = <Language> {
    ...
    create_subtext: "Vamos a crear un nuevo monedero para que puedas empezar a usar Danecoin.",
    ...
    warning_text_1: "Anota las palabras en el orden correcto y mantenlas a salvo (offline). Si pierdes estas palabras, no podrás acceder a tu Danecoin.",
    ...
    // Send
    send_to: 'Enviar solo a direcciones de Danecoin (DANE)',
    bitcoin_address: 'Dirección de Danecoin',
    address: 'Dirección',
    ...
    dust_error: "La cantidad que intentas enviar es demasiado pequeña para que la red Danecoin pueda procesarla.",
    bitcoin_network_fee: "Comisión de red",

    // Receive
    receive_only: 'Recibir solo Danecoin',
