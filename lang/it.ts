...
var it = <Language> {
    ...
    create_subtext: "Creeremo un nuovo wallet per te così potrai iniziare ad usare Danecoin.",
    ...
    warning_text_1: "Annota le parole nell'ordine corretto e tienile al sicuro, offline. Se perdi queste parole, non potrai più accedere ai tuoi Danecoin.",
    ...
    // Send
    send_to: 'Inviare solo ad indirizzi Danecoin (DANE)',
    bitcoin_address: 'Indirizzo Danecoin',
    address: 'Indirizzo',
    ...
    dust_error: "L'importo che stai tentando di inviare è troppo piccolo per essere elaborato dalla rete Danecoin.",
    bitcoin_network_fee: "Commissione di Rete Danecoin",

    // Receive
    receive_only: 'Ricevi solo Danecoin',
