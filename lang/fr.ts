...
var fr = <Language> {
    ...
    create_subtext: "Pour que vous puissiez commencer à utiliser Danecoin nous allons vous créer un nouveau portefeuille.",
    ...
    warning_text_1: "Écrivez ces mots dans l'ordre et conservez les en sécurité, hors ligne. Si vous perdez ces mots, vous ne serez plus en mesure d'accéder à vos Danecoins.",
    ...
    buy_bitcoin: 'Acheter du Danecoin',
    ...
    // Send
    send_to: 'Envoyer seulement aux adresses Danecoin (DANE)',
    bitcoin_address: 'Adresse Danecoin',
    address: 'Adresse',
    ...
    dust_error: "Le montant que vous essayez d'envoyer est trop faible pour être traité par le réseau Danecoin.",
    bitcoin_network_fee: "Frais de réseau Danecoin",
