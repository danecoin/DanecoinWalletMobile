...
var pt_br = <Language> {
    ...
    create_subtext: "Nós vamos criar uma nova carteira para que você possa começar a usar Danecoins.",
    ...
    warning_text_1: "Escreva as palavras na ordem correta e mantenha-as seguras, offline. Se você perder essas palavras, não conseguirá acessar seus Danecoins.",
    ...
    // Send
    send_to: 'Envie apenas para endereços Danecoin (DANE)',
    bitcoin_address: 'Endereço Danecoin',
    address: 'Endereço',
    ...
    dust_error: "A quantia que você está tentando enviar é muito pequena para a rede Danecoin processar.",
    bitcoin_network_fee: "Taxa de rede Danecoin",

    // Receive
    receive_only: 'Receber apenas Danecoin',
