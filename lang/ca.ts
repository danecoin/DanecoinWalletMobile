...
var ca = <Language> {
    ...
    create_subtext: "Crearem un nou moneder perquè puguis començar a utilitzar Danecoin.",
    ...
    warning_text_1: "Escriu les paraules en l'ordre correcte i guarda-les en un lloc segur (offline). Si perds aquestes paraules, no podrás accedir al teu Danecoin.",
    ...
    // Send
    send_to: 'Enviar només a direccions de Danecoin (DANE)',
    bitcoin_address: 'Adreça de Danecoin',
    address: 'Adreça',
    ...
    dust_error: "La quantitat que estàs intentant enviar és massa petita perquè la xarxa Danecoin la pugui processar.",
    bitcoin_network_fee: "Comissió de xarxa",

    // Receive
    receive_only: 'Rebre només Danecoin',
