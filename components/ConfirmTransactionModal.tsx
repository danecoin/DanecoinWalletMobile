                        ...
                        <View style={{ padding: 20 }}>
                            ...
                            <View style={styles.amountDetailsContainer}>
                                ...
                                <View style={styles.amountDetails}>
                                    <Text style={styles.amountText}>{props.btcAmount} DANE</Text>
                            ...
                            <View style={styles.amountDetailsContainer}>
                                ...
                                <View style={styles.amountDetails}>
                                    <Text style={styles.amountText}>{new BigNumber(props.feeAmount).dividedBy(100000000).toString()} DANE</Text>
                            ...
                            <View style={styles.amountDetailsContainer}>
                                ...
                                <View style={styles.amountDetails}>
                                    <Text style={styles.amountText}>{new BigNumber(props.feeAmount).dividedBy(100000000).plus(props.btcAmount).toString()} DANE</Text>
                            ...
                            <View style={styles.amountDetailsContainer}>
                                ...
                                <View style={styles.amountDetails}>
                                    <Text style={styles.amountText}>{props.sendingMax ? new BigNumber(props.btcAmount).plus(new BigNumber(props.feeAmount).dividedBy(100000000)).toString() : new BigNumber(props.btcAmount).toString()} DANE</Text>
