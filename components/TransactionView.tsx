    ...
    return (
        <View style={styles.container}>
            <View style={styles.innerContainer}>
                ...
                <View style={{}}>
                    <View style={{ flexDirection: 'row' }}><Text style={[(props.transaction.amount.includes('-') ? styles.amountExpense : styles.amountIncome), { width: 90, textAlign: 'right', paddingRight: 5 }]}>{props.transaction.amount}</Text><Text style={styles.grayedText}>DANE</Text></View>
